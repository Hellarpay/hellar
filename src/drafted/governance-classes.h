 ...
 *
 *   // network
 *   CHellarNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.hellar.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHellarNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: HellarNetwork
// //   -- signature requirements : Key1(User)
// class CHellarNetworkVariable : public CGovernanceObject
// {
// private:
