...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HellarNetwork") type = HellarNetwork;
    if(strType == "HellarNetworkVariable") type = HellarNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HellarNetwork) s = "HellarNetwork";
    if(type == HellarNetworkVariable) s = "HellarNetworkVariable";
