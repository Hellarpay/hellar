    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Hellar Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Hellar Core"));
...
These denominations are 0.01 HELLAR, 0.1 HELLAR, 1 HELLAR and 10 HELLAR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://hellarpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://hellarpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Hellar Core is shutting down...") + "<br /><br />" +
