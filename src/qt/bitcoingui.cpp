    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Hellar Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Hellar Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hellar Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Hellar Core help message to get a list with possible Hellar Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Hellar Core client") + " " + networkStyle->getTitleAddText();
