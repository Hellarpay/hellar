    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HELLAR-light"), QVariant("light"));
    ui->theme->addItem(QString("HELLAR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HELLAR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HELLAR-traditional"), QVariant("trad"));
