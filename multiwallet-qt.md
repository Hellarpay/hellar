...
Only requiring some minor changes is hellar.cpp.
...
Changes to hellar.cpp
----------------------
hellar.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
