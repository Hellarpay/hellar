TOR SUPPORT IN HELLAR CORE
=======================

It is possible to run Hellar Core as a Tor hidden service, and connect to such services.
...
1. Run Hellar Core behind a Tor proxy
----------------------------------

The first step is running Hellar Core behind a Tor proxy. This will already make all
...
2. Run a Hellar Core hidden server
-------------------------------
...
your hellard's P2P listen port (9989 by default).
	...
	-externalip=X   You can tell Hellar Core about its publicly reachable address using
	                ...
	                /var/lib/tor/hellarcore-service/hostname. Onion addresses are given
...
3. List of known Hellar Core Tor relays
------------------------------------
...
Hellar Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Hellar Core is listening, and
