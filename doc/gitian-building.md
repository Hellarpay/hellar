...
in the Hellar Core repository under 'Fetch and build inputs' to install sources which require
...
For example:
```bash
URL=https://github.com/crowning-/hellar.git
...
BTCPATH=/some/root/path/hellar.git
SIGPATH=/some/root/path/hellar-detached-sigs.git
...
[hellar/gitian.sigs](https://github.com/hellarpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
